...
list. The nodes in the child list should appear after curr and before curr.next in
 the flattened list.
...
Intuition: Read the whole article at https://leetcode.com/problems/flatten-a-multilevel-doubly-linked-list/solution/
"""
