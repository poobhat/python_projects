...
"""
"""
Runtime: 228 ms, faster than 9.44% of Python3 online submissions for Intersection of 
Two Linked Lists.
Memory Usage: 29.9 MB, less than 9.39%.
...
class Solution:
    def getIntersectionNode(self, headA: ListNode, headB: ListNode) -> [ListNode]:
        ...
        # Traverse through one linked list completely and add the nodes
        # to a set
