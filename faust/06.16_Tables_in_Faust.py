...
#
uri_summary_table_new = app.Table("uri_table_new", default=int)
...
async def clickevent(clickevents):
    ...
    async for ce in clickevents.group_by(ClickEvent.uri).filter(lambda x : x.uri == 'http://www.cross.com/app/tag/category/homepage/'):
        #
        ...
        #       See: https://faust.readthedocs.io/en/latest/userguide/tables.html#basics
        #
        uri_summary_table_new[ce.uri] += ce.number
        print(f"{ce.uri} : {uri_summary_table_new[ce.uri]}")
